...
export default function User() {
    ...
    const [names, setNames] = useState<IUserUpdateRequest>({ firstname: "", lastname: "" })
                    ...
                    <div className='flex flex-col'>
                        <div className='flex flex-col justify-between m-5 gap-2 w-[500px]'>
                            <div>
                                ...
                                <input type="text" value={names.firstname} onChange={(e) => setNames({ firstname: e.target.value, lastname: names.lastname })} id="firstname" className="block w-[500px] p-2 border rounded sm:text-xs hover:border-yellow-500 focus:outline-none focus:border-yellow-500 focus:ring-yellow-500" placeholder='First Name' required />
                            </div>
                            <div>
                                <label className="block mb-2 text-xs font-medium">Last Name</label>
                                <input type="text" value={names.lastname} onChange={(e) => setNames({ lastname: e.target.value, firstname: names.firstname })} id="lastname" className="block w-[500px] p-2 border rounded sm:text-xs hover:border-yellow-500 focus:outline-none focus:border-yellow-500 focus:ring-yellow-500" placeholder='Last Name' required />
                            </div>
                            {roles.length > 0 ? <div>
                        ...
                        <div className='flex justify-end'>
                            <button className='bg-black rounded-md px-6 py-2 mb-5 mr-5 text-white text-xs'>
                                Save Changes
                            </button>
                        </div>
                    </div>
